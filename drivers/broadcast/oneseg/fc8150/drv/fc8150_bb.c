...
#endif
#elif (BBM_XTAL_FREQ == 19200) || defined(USE_PM8941_XO_A2)
...
#elif (BBM_XTAL_FREQ == 26000) || defined(USE_PM8941_XO_A2)
#ifdef USE_PM8941_XO_A2
	if (use_pm8941_xo_a2_192000 == 0) {
#endif /* USE_PM8941_XO_A2 */
	bbm_write(hDevice, 0x0016, 2);
#if (BBM_BAND_WIDTH == 6)
...
int fc8150_probe(HANDLE hDevice)
{
	...
	PRINTF(hDevice, "[1seg] FC8150 fc8150_probe bbm_word_read ver : 0x%04x \n", ver);
