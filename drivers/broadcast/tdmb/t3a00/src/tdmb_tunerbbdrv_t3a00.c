...
//static t3a00_service_type serviceType;
...
int8 tunerbb_drv_t3a00_init(void)
{
	...
	//tunerbb_drv_t3a00_rw_test( );   // for test
	...
	m_ucPLL_Mode = INPUT_CLOCK_19200KHZ; //INPUT_CLOCK_24576KHZ;
...
int8 tunerbb_drv_t3a00_tune(int nFreqNo)
{
	...
	//printk("tunerbb_drv_t3a00_tune nFreqNo = %d, ulFreq = %d \n", nFreqNo, ulFreq);
...
int8 tunerbb_drv_t3a00_get_fic(uint8* buffer, uint32* buffer_size/* bool crc_onoff*/)
{
...
int8 tunerbb_drv_t3a00_get_fic(uint8* buffer, uint32* buffer_size /*, boolean cr_onoff */)
{
	INC_UINT32 uiFicSize;
