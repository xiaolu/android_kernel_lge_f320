...
TOOLCHAIN_LINARO="${HOME}/AK/AK-google/arm-eabi-4.6/bin/arm-eabi-"
 ...
 echo ""; echo "# G2 SPECIAL EDITION FOR SKT START ///\\\ ------------------------------------------------------------------------------------------------"; echo ""
  #
  ...
  rm -rfv .config; rm -rfv .config.old
   ...
   echo ""
  #make CROSS_COMPILE=$TOOLCHAIN_GOOGLE ARCH=arm g2-skt-perf_defconfig
  make CROSS_COMPILE=$TOOLCHAIN_LINARO ARCH=arm g2-skt-perf_defconfig


  g2_ver="G2.JB42.001.SKT";
